...
// Grade Links
document.getElementById('grade-1-link')?.addEventListener('click', (e) => {
    e.preventDefault();
    const grade1Words = ['cat', 'cup', 'dog', 'map', 'bat', 'hat', 'sun', 'run', 'man', 'fan', 'hen', 'bed', 'bug', 'jump', 'rug', 'hug', 'home', 'look', 'door', 'good', 'cap', 'food', 'tap', 'help', 'lip', 'hand', 'sip', 'tip', 'foot', 'cake', 'rain', 'box', 'star', 'fish', 'tree', 'ball', 'frog', 'ring', 'bird', 'play', 'nest', 'table', 'book', 'kite', 'chair', 'smile', 'clean', 'bread', 'story', 'magic', 'game', 'grass', 'clock', 'quick', 'blue', 'sleep', 'family', 'pink', 'animal', 'milk', 'train', 'night', 'people', 'lamp', 'shine', 'father', 'ship', 'bring', 'mother', 'king', 'swing', 'sister', 'small', 'school', 'apple', 'plant', 'friend', 'drink', 'garden', 'sweet'];
    customWordsInput.value = grade1Words.join(', ');
});
